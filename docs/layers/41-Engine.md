...
每个 Run 的关键事件可投影成摘要、trace、诊断、健康和 incident 信息。Server 暴露这些只读视图；具体 API 见[Server 文档](43-Server.md)。
...
| 主题 | 专题文档 | 阅读目标 |
| --- | --- | --- |
| 执行、Run、pipeline 与恢复 | [20 · Agent Loop 运行机制](../subsystems/20-Agent-Loop.md) | 理解 Run 状态、checkpoint、gate、回退与 provisional 提交 |
| 单步模型—工具循环 | [20 · Agent Loop 运行机制](../subsystems/20-Agent-Loop.md) | 理解事件、预算、流式与压缩 |
| Prompt 与上下文预算 | [22 · 上下文治理](../subsystems/22-上下文治理.md) | 理解信任分层、fitting 与压缩 |
| Identity 与路由 | [04d · Identity](../subsystems/28-身份与路由.md) | 理解 YAML 能力档案与 direct/pipeline 路径选择 |
| 模型 provider | [04b · LLM](../subsystems/25-LLM集成.md) | 理解 adapter、配置与 usage |
| 工具运行时 | [23 · 工具与安全体系](../subsystems/23-工具与安全.md) | 理解发现、schema、scoped capability 与 ledger |
| 安全与审批 | [23 · 工具与安全体系](../subsystems/23-工具与安全.md) | 理解 policy、guard、fact gate 与 approval |
| Skill 运行时 | [04h · Skill](../subsystems/29-Skill技能系统.md) | 理解发现、enablement、执行与交接 |
| 外部 MCP | [04i · MCP](../subsystems/26-MCP集成.md) | 理解 transport、session pool 与本地治理 |
| 可观测性 | [04j · Observability](../subsystems/27-可观测性.md) | 理解 trace、summary、incident 与 health |
| 主机执行环境 | [04k · Sandbox](../subsystems/30-Sandbox执行环境.md) | 理解进程组、I/O 上限、取消与 Seatbelt |
| 记忆系统 | [21 · 记忆系统](../subsystems/21-记忆系统.md) | 理解证据、双视图编译、审核与维护 |
| 内容层编辑方式 | [06 · Agents](42-Agents.md) | 理解 identity、pipeline、skill 与 tool provider 的内容来源 |
