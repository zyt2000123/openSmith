...
当前实现文档只描述已落地、可由代码或测试验证的契约；历史设计、调研与参考资料只提供背景，不代表产品能力。阅读和维护规范见 [00 · 文档阅读指南与表达规范](00-文档阅读指南与表达规范.md)。
...
根目录的 `01`–`08` 和 `10` 说明已经落入源码的能力、接口和边界。它们应满足：
